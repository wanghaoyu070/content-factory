...
const navItems = [
  ...
  { href: '/analysis', label: '分析', icon: Search },
  { href: '/create', label: '创作', icon: PenTool },
...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 glass-sidebar border-t border-[#2d2d44] safe-area-bottom">
